...
class DocumentShikayatAdmin extends StatefulWidget {
  const DocumentShikayatAdmin({Key? key}) : super(key: key);

  @override
  DocumentShikayatAdminState createState() => DocumentShikayatAdminState();
}

class DocumentShikayatAdminState extends State<DocumentShikayatAdmin> {
  ...
  Future<List<Map<String, dynamic>>> getDataFromFirestore() async {
    ...
    final QuerySnapshot snapshot = await FirebaseFirestore.instance
        ...
        .where('Complaint_type', isEqualTo: 'Document Related')
        .get();
                                                            ...
                                                            title: Text(
                                                              "Complaint status: " +
                                                                  dataList[index]
                                                                      ['status'],
                                                              style: GoogleFonts.lato(
                                                                  color: ((dataList[index]['status']) == "Pending")
                                                                      ? Colors.red
                                                                      : (dataList[index]['status']) == "Complaint Approved"
                                                                          ? Colors.yellow
                                                                          : Colors.green),
                                                            ),
                                                            content: Row(
