...
class ExamShikayatAdmin extends StatefulWidget {
  const ExamShikayatAdmin({Key? key}) : super(key: key);

  @override
  ExamShikayatAdminState createState() => ExamShikayatAdminState();
}

class ExamShikayatAdminState extends State<ExamShikayatAdmin> {
  ...
  Future<List<Map<String, dynamic>>> getDataFromFirestore() async {
    ...
    final QuerySnapshot snapshot = await FirebaseFirestore.instance
        ...
        .where('Complaint_type', isEqualTo: 'Exam Related')
        .get();
                                            ...
                                            MaterialButton(
                                              onPressed: () {
                                                ...
                                                final snackbar = SnackBar(
                                                  content: Text(
                                                    "You are Updating status of the Complaint!",
                                                    style: GoogleFonts.lato(),
                                                  ),
                                                  elevation: 20,
                                                  backgroundColor:
