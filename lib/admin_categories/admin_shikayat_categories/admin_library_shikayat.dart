...
class LibraryShikayatAdmin extends StatefulWidget {
  const LibraryShikayatAdmin({Key? key}) : super(key: key);

  @override
  LibraryShikayatAdminState createState() => LibraryShikayatAdminState();
}

class LibraryShikayatAdminState extends State<LibraryShikayatAdmin> {
  ...
  Future<List<Map<String, dynamic>>> getDataFromFirestore() async {
    ...
    final QuerySnapshot snapshot = await FirebaseFirestore.instance
        ...
        .where('Complaint_type', isEqualTo: 'Library Related')
        .get();
