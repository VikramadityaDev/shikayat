...
class ResolvedShikayat extends StatefulWidget {
  const ResolvedShikayat({Key? key}) : super(key: key);

  @override
  ResolvedShikayatState createState() => ResolvedShikayatState();
}

class ResolvedShikayatState extends State<ResolvedShikayat> {
